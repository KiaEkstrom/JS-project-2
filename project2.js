/* Here is a lot of functions for this web page to work. Since I have 3 bands, I have 3 main functions (named "load_band"). These functions then call other functions.
	...
	// Here are the event listeners which are connected to the band buttons with id's.
	...
	xmlhttp.onreadystatechange = function() {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {		
			...
			// heading rows
				...
				show += "</tr>";
				show += "<tr>";
					show += "<td rowspan='12'><img src='https://lastfm.freetls.fastly.net/i/u/174s/0d276722144debdb9ad98ca3b13dfbd5.jpg'</td>"; 
				show += "</tr>";
